...
const buyingListing = (props) => {
  ...
  return (
    <div className={`buying-listing-blog-post-card ${props.rootClassName} `}>
      <div
        className="buying-listing-hero"
        style={{
          backgroundImage: `url(${thumbnailURL})`,
        }}
      >
        <div className="buying-listing-top">
          <div className="buying-listing-images">
            <svg
              viewBox="0 0 1097.142857142857 1024"
              className="buying-listing-icon"
            >
              <path
            ...
            <span className="buying-listing-text">{props.photos}</span>
          </div>
        </div>
        <div className="buying-listing-bottom">
          <div className="buying-listing-location">
            <svg
              viewBox="0 0 585.1428571428571 1024"
              className="buying-listing-icon02"
            >
              <path
            ...
            <span className="buying-listing-text2">
      ...
      <div className="buying-listing-container">
        ...
        <div className="buying-listing-container1">
          <svg
            ...
            className="buying-listing-icon04"
          >
            <path
          ...
          <span className="buying-listing-text6">{props.beds}</span>
          <svg viewBox="0 0 1024 1024" className="buying-listing-icon06">
            <path
          ...
          <span className="buying-listing-text7">{props.baths}</span>
          <svg viewBox="0 0 1024 1024" className="buying-listing-icon08">
            <path
