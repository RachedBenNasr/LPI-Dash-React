...
const Vente = (props) => {
  ...
  useEffect(() => {
    const fetchCommercialListings = async () => {
      ...
      const fetchListings = (listingsRef) => {
      ...
      try {
        const saleListings = await fetchListings(saleListingsRef);
        const rentListings = await fetchListings(rentListingsRef);
  ...
  return (
    <div className="vente-container">
      <span className="vente-title">Commercial</span>
